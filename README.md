...
<img width="350" height="210" alt="bad example" src="https://github.com/user-attachments/assets/7376d5d7-b5c6-4446-90e7-46277d121c3a" /> <img width="557" height="347" alt="Screenshot 2026-08-28 021311" src="https://github.com/user-attachments/assets/09597519-d71a-40c9-bb74-d64a0b2e5f46" />

A better signal is shown in Graph B. Here, the two movements are much easier to distinguish because one channel becomes dominant during flexion, while the other becomes dominant during extension. In this example, the blue channel represents the flexor muscles and the red channel represents the extensor muscles. Dominant flexor activity is marked with "F", while dominant extensor activity is marked with "E". The achieved accurary with a good electrode placement should be above 95%. 
