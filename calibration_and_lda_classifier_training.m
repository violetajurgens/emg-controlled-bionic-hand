...
% Estimate slowly changing baseline
ch1Baseline = movmedian(ch1Raw, baselineN);
ch2Baseline = movmedian(ch2Raw, baselineN);
...
%% =========================================================
%% ACTIVITY MEASURE
% This is the vector sum of MAVs from both channels.
...
%% =========================================================
%% RAW ACCURACY OF LDA MODEL THROUGH CROSS-VALIDATION
